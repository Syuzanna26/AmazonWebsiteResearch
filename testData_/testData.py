...
#User Data
validUser = User("syuzanna26.12@gmail.com", "Davit2602")
userWithInvalidPassword = User("syuzanna26.12@gmail.com", "WrongPassword")
userWithInvalidUsername = User("WrongUsername", "Davit2602")
